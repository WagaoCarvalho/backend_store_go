...
migrate_create_services_antt_table:
	@migrate create -ext sql -dir db/migrations -seq create_services_antts_table

migrate_create_services_antt_categories_table:
	@migrate create -ext sql -dir db/migrations -seq create_services_antt_categories_table

migrate_create_services_antt_category_relations_table:
	@migrate create -ext sql -dir db/migrations -seq create_services_antt_category_relations_table
