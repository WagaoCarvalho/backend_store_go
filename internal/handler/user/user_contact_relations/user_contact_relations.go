...
type UserContactRelationHandler struct {
	service service.UserContactRelationServices
	logger  *logger.LogAdapter
}

func NewUserContactRelationHandler(service service.UserContactRelationServices, logger *logger.LogAdapter) *UserContactRelationHandler {
