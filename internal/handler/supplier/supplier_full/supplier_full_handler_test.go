...
import (
	...
	model_supplier "github.com/WagaoCarvalho/backend_store_go/internal/models/supplier"
	model_categories "github.com/WagaoCarvalho/backend_store_go/internal/models/supplier/supplier_categories"
	model_supplier_full "github.com/WagaoCarvalho/backend_store_go/internal/models/supplier/supplier_full"
	services "github.com/WagaoCarvalho/backend_store_go/internal/services/suppliers/supplier_full_services/supplier_full_services_mock"
...
func TestSupplierHandler_CreateFull(t *testing.T) {
	mockService := new(services.MockSupplierFullService)
