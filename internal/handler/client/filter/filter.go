...
func (h *clientFilterHandler) validateQueryParams(r *http.Request) error {
...
func (h *clientFilterHandler) parseFilterDTO(r *http.Request) (dtoFilter.ClientFilterDTO, error) {
	var dto dtoFilter.ClientFilterDTO
	query := r.URL.Query()
...
func (h *clientFilterHandler) parseTimeParam(query map[string][]string, param string) *time.Time {
...
func countFiltersApplied(dto dtoFilter.ClientFilterDTO) int {
	count := 0
