...
func (h *clientCpfHandler) Create(w http.ResponseWriter, r *http.Request) {
	const ref = "[ClientHandler - Create] "
	ctx := r.Context()

	h.logger.Info(ctx, ref+logger.LogCreateInit, nil)

	var clientDTO dto.ClientCpfDTO
	...
	client := dto.ToClientCpfModel(clientDTO)
	...
	utils.ToJSON(w, http.StatusCreated, utils.DefaultResponse{
		...
		Data:    dto.ToClientCpfDTO(createdClient),
	})
}

func (h *clientCpfHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	clientModel := dto.ToClientCpfModel(clientDTO)
	clientModel.ID = uid
	...
	if err != nil {
		...
		case errors.Is(err, errMsg.ErrDuplicate):
			h.logger.Warn(ctx, ref+logger.LogErrDuplicate, map[string]any{
				"client_id": uid,
			})
			utils.ErrorResponse(w, err, http.StatusConflict)
			return
	...
	utils.ToJSON(w, http.StatusOK, utils.DefaultResponse{
		...
		Data:    dto.ToClientCpfDTO(clientModel),
	})
}

func (h *clientCpfHandler) Delete(w http.ResponseWriter, r *http.Request) {
