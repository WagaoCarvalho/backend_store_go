...
func (r *saleItem) Create(ctx context.Context, item *models.SaleItem) (*models.SaleItem, error) {
	const query = `
...
func (r *saleItem) Update(ctx context.Context, item *models.SaleItem) error {
	const query = `
		UPDATE sale_items
		SET 
			sale_id     = $1,
...
func (r *saleItem) Delete(ctx context.Context, id int64) error {
...
func (r *saleItem) DeleteBySaleID(ctx context.Context, saleID int64) error {
