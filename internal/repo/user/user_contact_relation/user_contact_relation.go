...
func NewUserContactRelation(db *pgxpool.Pool) UserContactRelation {
...
func (r *userContactRelation) CreateTx(ctx context.Context, tx pgx.Tx, relation *models.UserContactRelation) (*models.UserContactRelation, error) {
	const query = `
		INSERT INTO user_contact_relations (user_id, contact_id, created_at)
		VALUES ($1, $2, NOW());
	`
