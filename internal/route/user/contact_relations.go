...
import (
	...
	handler "github.com/WagaoCarvalho/backend_store_go/internal/handler/user/contact_relation"
...
func RegisterUserContactRelationRoutes(
	...
	relationService := service.NewUserContactRelationService(relationRepo)
