...
func Test_UserContactRelationServices_Create(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		service := NewUserContactRelationServices(mockRepo)
	...
	t.Run("Duplicate Relation Exists", func(t *testing.T) {
		...
		input := &models.UserContactRelations{UserID: 1, ContactID: 2}
		existing := &models.UserContactRelations{UserID: 1, ContactID: 2}

		mockRepo.On("Create", mock.Anything, input).Return(nil, err_msg.ErrRelationExists)
		mockRepo.On("GetAllRelationsByUserID", mock.Anything, int64(1)).Return([]*models.UserContactRelations{existing}, nil)
	...
	t.Run("Duplicate Relation Exists but not found in GetAll", func(t *testing.T) {
		...
		mockRepo.On("Create", mock.Anything, input).Return(nil, err_msg.ErrRelationExists)
		mockRepo.On("GetAllRelationsByUserID", mock.Anything, int64(1)).Return([]*models.UserContactRelations{}, nil)
...
func TestUserContactRelationServices_GetAllRelationsByUserID(t *testing.T) {
	t.Run("success - retorna lista de relações", func(t *testing.T) {
		...
		userID := int64(1)
		expectedRelations := []*models.UserContactRelations{
