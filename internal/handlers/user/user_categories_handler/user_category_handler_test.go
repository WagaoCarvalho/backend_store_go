...
import (
	...
	services_mock "github.com/WagaoCarvalho/backend_store_go/internal/services/user/user_categories/user_categories_services_mock"
...
func TestUserCategoryHandler_Update(t *testing.T) {
	...
	t.Run("InvalidID", func(t *testing.T) {
		handler := NewUserCategoryHandler(new(services_mock.MockUserCategoryService), logger)
