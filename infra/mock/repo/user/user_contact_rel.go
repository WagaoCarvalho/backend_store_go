...
func (m *MockUserContactRelationRepo) Create(ctx context.Context, relation *models.UserContactRelations) (*models.UserContactRelations, error) {
	args := m.Called(ctx, relation)
	result := args.Get(0)
	if result == nil {
		return nil, args.Error(1)
	}
	return result.(*models.UserContactRelations), args.Error(1)
}

func (m *MockUserContactRelationRepo) CreateTx(ctx context.Context, tx pgx.Tx, relation *models.UserContactRelations) (*models.UserContactRelations, error) {
...
func (m *MockUserContactRelationRepo) GetAllRelationsByUserID(ctx context.Context, userID int64) ([]*models.UserContactRelations, error) {
