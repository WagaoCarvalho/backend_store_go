...
func (m *MockUser) GetAll(ctx context.Context) ([]*models.User, error) {
	args := m.Called(ctx)
...
func (m *MockUser) GetByID(ctx context.Context, uid int64) (*models.User, error) {
...
func (m *MockUser) GetVersionByID(ctx context.Context, uid int64) (int64, error) {
	args := m.Called(ctx, uid)
...
func (m *MockUser) GetByName(ctx context.Context, name string) ([]*models.User, error) {
...
func (m *MockUser) Disable(ctx context.Context, id int64) error {
	args := m.Called(ctx, id)
	return args.Error(0)
}

func (m *MockUser) Enable(ctx context.Context, id int64) error {
	args := m.Called(ctx, id)
	return args.Error(0)
}

func (m *MockUser) Delete(ctx context.Context, uid int64) error {
	args := m.Called(ctx, uid)
	return args.Error(0)
}
